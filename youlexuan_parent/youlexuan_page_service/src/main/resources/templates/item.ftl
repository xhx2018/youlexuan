...
<#else>
	<#assign customAttributeList='[]'?eval/>
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							...
							<dl>
								...
								<dd ng-click="updateSpec('${spec.attributeName}','${val}')"><a href="javascript:;" class="{{isSelected('${spec.attributeName}','${val}')?'selected':''}}">${val}<span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
							</dl>
							</#list>
						</div>
