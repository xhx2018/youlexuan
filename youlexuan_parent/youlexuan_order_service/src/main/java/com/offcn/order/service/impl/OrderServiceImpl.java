...
public class OrderServiceImpl implements OrderService {
	...
	public void add(TbOrder o) {
		...
		//针对id的处理
		//订单表的数据，随着使用时间的延续，会不会越来越大，甚至大到不可思议


		//1个cart对应一个order
		//1个cart对象中的orderItemList 对应order表的子表tb_order_item表
		double totalSum = 0;
	...
	public void updateOrderStatus(String name,String out_trade_no) {
		...
		TbPayLog payLog = (TbPayLog) redisTemplate.boundHashOps("payLog").get(out_trade_no);
